...
function report(): BundleStateReport {
  return {
    ...
    assets: [
      { name: "assets/app.js", sizeBytes: 100, gzipBytes: 40, usedModules: ["react"], rawBytes: btoa("console.log(1)"), kind: "js" },
      { name: "assets/style.css", sizeBytes: 50, gzipBytes: 20, usedModules: [], rawBytes: btoa("a{}"), kind: "css" },
    ...
    insights: {
      unusedDeclaredDeps: [], gzipRatio: null, largestAssets: [], totalSizeBytes: 0, totalGzipBytes: null,
      versionClashes: [], circularDepGroups: [], circularDepCount: 0,
